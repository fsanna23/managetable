(requirejs.specified("base/js/namespace")
  ...
  : function (deps, callback) {
      ...
      return define("nbextensions/managetable/chosenjs", deps, callback);
...
*/
  ...
  function initializeChosenJs($, Jupyter) {
    console.log("Chosen JS is running");
...
if (!requirejs.specified("base/js/namespace")) {
  window.managetable_main = function (cfg, st) {
    ...
    // actual call is made
    requirejs(["nbextensions/managetable/chosenjs"], function (chosenJs) {
      return chosenJs;
    });
  };
}
